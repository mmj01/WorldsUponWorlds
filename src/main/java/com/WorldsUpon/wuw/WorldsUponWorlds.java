...
@Mod(WorldsUponWorlds.MODID)
public class WorldsUponWorlds {
    public static final String MODID = "wuw";
    ...
    public WorldsUponWorlds(IEventBus modEventBus, ModContainer modContainer) {
        NeoForge.EVENT_BUS.register(GameStart.class);
